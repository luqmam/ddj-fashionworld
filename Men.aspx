<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Men.aspx.cs" Inherits="Men"Title="Untitled Page" %>
    ...
    <div class="aspGrid">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="AccessDataSource1"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="category_type" DataNavigateUrlFormatString="~/MenCategoryType.aspx?category_type={0}"
